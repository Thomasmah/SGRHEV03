        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
            ...
            <div class="max-w-7xl mx-auto p-6 lg:p-8">
                ...
                <div style="text-align: center;">
                    ...
                    <div class=" d-block text-center text-sm text-gray-500 sm:text-left ">
           
                                <p class="d-block">Seja bem vindo! :)</p>
                                <br>
                                        ...
                                        @if (Route::has('login'))
                                            ...
                                            <?php
                                                ...
                                                echo("<p> Voçe Está Logado! Aguarde O Email de Confiração de Registro </p>");
                                                }else {
                                                echo(" <p>Voçe esta logado!</p> ");
                                                }
                                            ?>
                                            @endauth
                                        @endif
                    ...
                    <div class="text-center text-sm text-gray-500 sm:text-left ">  
                        ...
                        <a style="display: block;" href="{{ route('inicio') }}" class="p-3 bg-white from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500 ">
                                    Entrar
                        </a>
                    </div>
                </div>
