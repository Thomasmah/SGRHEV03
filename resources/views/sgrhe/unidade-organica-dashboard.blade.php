                            ...
                            <div class="card">
                              <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                  ...
                                  <li class="nav-item"><a class="nav-link" href="#Solicitar" data-toggle="tab">Aproveitamento I Trimestre</a></li>
                                  <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Aproveitamento II Trimestre</a></li>
                                  <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Aproveitamento III Trimestre</a></li>
                                  <li class="nav-item"><a class="nav-link" href="#anuario" data-toggle="tab">Anuário</a></li>
                                </ul>
                              </div><!-- /.card-header -->
                              <div class="card-body">
                                   ...
                                   <!--/tab-pane-->
                                        ...
                                        <div class="tab-pane" id="Solicitar">
                                          <!-- Formulario I  Trimestre -->
                                            ...
                                            <h4 class="card-header text-center"> Aproveitamento escolar do trimestre. </h4>
                                            ...
                                            @else
                                            <h4 class="card-header text-center"> Não foram submetidos formulário para esse trimestre. </h4>
                                            @endif
