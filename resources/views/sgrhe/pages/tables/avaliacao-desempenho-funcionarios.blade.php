            ...
            <div class="content-wrapper">
              ...
              <section class="content-header">
                <div class="container-fluid">
                  <div class="row mb-2">
                    <div class="col-sm-6">
                      <h1> Avaliação de Desempenho para Homologação </h1>
                    </div>
                    <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Avaliação de Desempenho para Homologação </li>
                      </ol>
                    </div>
                  </div>
                </div><!-- /.container-fluid -->
                      ...
                      <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                              ...
                              @foreach ($dados as $avaliacao)
                                            <tr>
                                                <td>{{ $avaliacao->numeroAgente }}</td> <td>{{ $avaliacao->nomeCompleto }}</td> <td>{{ $avaliacao->numeroBI }}</td> <td>{{ $avaliacao->eqt }}</td> <td>{{ $avaliacao->categoria }}</td> <td>{{ $avaliacao->total }}</td> <td>{{ $avaliacao->designacao }}</td>
