            ...
            <section class="content">
              ...
              <form action="{{ route('funcionarios.verificarPessoa') }}" method="get">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="numeroBI" id="numeroBI" class="form-control" placeholder="Digite o numero do Bilhete da Pessoa que Necessita Cadastrar" require>
                  </div>
                                ...
                                <form id="quickForm">
                                  <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="numeroBI" id="numeroBI" class="form-control" value="{{ old('numeroBI',$pessoa->numeroBI ?? 'numeroBI') }}" require readonly>
                                    </div>
                                    <div class="form-group">
                                      <label for="biValidade"> Validade do Bilhete de Identidade "BI"</label>
                                      <input type="date" name="biValidade" class="form-control" id="biValidade" value="{{ old('validadeBI',$pessoa->validadeBI ?? 'validadeBI') }}" require readonly>
                                    </div>
                                    <div class="form-group" style="display: none;">
                                      <label for="idPessoa">ID Pessoa</label>
                                      <input type="text" name="idPessoa" class="form-control" id="idPessoa"  value="{{ old('idPessoa',$funcionario->idPessoa ?? $pessoa->id) }}" require>
                                    </div>
                                    <div class="form-group">
                                      <label for="dataAdimissao">Data de Admissão</label>
                                      <input type="date" name="dataAdmissao" class="form-control" id="dataAdmissao" value="{{ old('dataAdmissao',$funcionario->dataAdmissao ?? 'dataAdamissao')  }}" require>
                                    </div>

                                    <div class="form-group">
                                      <label for="numeroAgente">Número de Agente</label>
                                      <input type="text" name="numeroAgente" class="form-control" id="numeroAgente" placeholder="Insira o número de Agente" value="{{ old('numeroAgente',$funcionario->numeroAgente ?? '')  }}" require>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        <label for="idCategoriaFuncionario">Categoria Funcionário</label>
                                          <select name="idCategoriaFuncionario" class="form-control select2">
                                            <option selected="selected" value="{{ isset($opcoesCategoriaFuncionario) ? $opcoesCategoriaFuncionario->id : '' }}">{{ isset($opcoesCategoriaFuncionario) ? $opcoesCategoriaFuncionario->categoria : 'Escolha uma Categoria de Funcionário' }}</option>
                                            @php
                                              $opcoesCategoriaFuncionario = App\Models\CategoriaFuncionario::all();
                                            @endphp
                                            @foreach ($opcoesCategoriaFuncionario as $CategoriaFuncionario)
                                            <option value="{{ old('id',$CategoriaFuncionario->id ?? 'id') }}">{{ old('categoria',$CategoriaFuncionario->categoria ?? 'categoria') }}</option>
                                            @endforeach 
                                          </select>
                                      </div>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="iban" class="form-control" id="iban" value="{{ old('iban',$funcionario->iban ?? '') }}" placeholder="AO06 0000 0004 029309303493930">
                                    </div>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" name="numeroTelefone" class="form-control" id="tel" value="{{ old('numeroTelefone',$funcionario->numeroTelefone ?? '') }}" placeholder="+244 922 275 032">
                                    </div>
